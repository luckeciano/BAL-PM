...
metric = 'ood_LogLikelihood'
# exp_names = [, 'ep_adp_rank_bald_reddit_7b_final', \
exp_names = ['ep_adp_softbald10000_bald_reddit_7b', 'ep_adp_softrank1.0_bald_reddit_7b', 'baepm_reddit_7b_ratiolog_final', \
                 'ep_adp_powerbald8_bald_reddit_7b'] #, 'ep_adp_powerbaldanneal_bald_reddit_7b'] #, 'al_batchent_nounc']
legend_dict = {
    ...
    'ep_adp_softrank1.0_bald_reddit_7b': 'SoftRankBALD',
    'ep_adp_softbald10000_bald_reddit_7b': 'SoftmaxBALD',
    'ep_adp_powerbald0.25_bald_reddit_7b': 'PowerBALD 0.25',
    'ep_adp_powerbald8_bald_reddit_7b': 'PowerBALD',
    'ep_adp_powerbaldanneal_bald_reddit_7b': 'AnnealedBALD'
}
...
for i, exp_name in enumerate(exp_names):
    ...
    if legend_dict[exp_name] == 'Random Sampling':
        ...
        line1 = plt.Line2D([xstmark, xstmark], [-0.665, final_rnd_perf], color='black', linestyle='--')
        line2 = plt.Line2D([xenmark, xenmark], [-0.665, final_rnd_perf], color='black', linestyle='--')
        ...
        ax.scatter([xstmark, xenmark], [-0.665, -0.665], color='black', s=30)
        ...
        ax.annotate(text=' ',xy=(xstmark, -0.665), xycoords='data',
				xytext=(xenmark + 320, -0.665),textcoords='data',
				arrowprops=dict(arrowstyle="<->", color='black', linewidth=1.5), va='center')
        ax.annotate(text='~68% less samples',xy=(((xstmark+xenmark)/2), -0.665 + 0.0007), xycoords='data',fontsize=15.0,textcoords='data',ha='center')
