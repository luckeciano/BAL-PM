...
for i, exp_name in enumerate(exp_names):
    ...
    if legend_dict[exp_name] == 'Random Sampling':
        ...
        ax.annotate(text='~32% fewer samples',xy=(((xstmark+xenmark)/2), -0.615 + 0.0007), xycoords='data',fontsize=14.0,textcoords='data',ha='center')
...
output_name = 'scaling_llms_70b_figure'
