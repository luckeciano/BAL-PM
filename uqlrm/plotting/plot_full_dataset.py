...
exp_names = ['rand_adp_rank_bald_reddit_7b_final', 'ep_adp_rank_bald_reddit_7b_final', 'baepm_reddit_7b_ratiolog_final']
legend_dict = {
...
stderr = full_data_baseline[f'{full_data_exp_name} - {metric_name}'].apply(lambda x: stats.sem(x, axis=None, ddof=0), axis=1)
...
ax.axhspan(mean.values[0] - stderr.values[0], mean.values[0] + stderr.values[0], facecolor='purple', alpha=0.3)
