...
exp_names = ['ep_rank_mcdrop_reddit_7b', 'batchstateentropy_mcdrop_reddit_7b', 'baepm_reddit_7b_ratiolog_final', 'ep_rank_ddu_avg_reddit_7b', 'batchstateentropy_ddu_avg_reddit_7b'] #, 'al_batchent_nounc']
legend_dict = {
    'baepm_reddit_7b_ratiolog_final': 'BAL-PM (ours)',
    'ep_rank_mcdrop_reddit_7b': 'MC-Dropout',
    'batchstateentropy_mcdrop_reddit_7b': 'MC-Dropout + Entropy',
    'ep_rank_ddu_avg_reddit_7b': 'LRU',
    'batchstateentropy_ddu_avg_reddit_7b': 'LRU + Entropy'
}
...
# ax.set_ylim(-0.66, -0.630)

ax.legend(loc='lower right')
plt.tight_layout()
# plt.subplots_adjust(left=0.1, right=0.9, top=0.9, bottom=0.1)
# Save the figure in EPS, PDF, and PNG formats
output_name = 'further_baselines_entropy_ood'
