...
exp_names = ['rand_adp_rank_bald_reddit_140b', 'ep_adp_rank_bald_reddit_140b', 'batchstateentropy_adp_rank_bald_reddit_140b'] #, 'al_batchent_nounc']
legend_dict = {
    'rand_adp_rank_bald_reddit_140b': 'Random Sampling',
    'ep_adp_rank_bald_reddit_140b': 'BALD',
    'batchstateentropy_adp_rank_bald_reddit_140b': 'BAL-PM (ours)'
}
...
for i, exp_name in enumerate(exp_names):
    ...
    if legend_dict[exp_name] == 'Random Sampling':
        ...
        ax.annotate(text='~31% fewer samples',xy=(((xstmark+xenmark)/2), -0.615 + 0.0007), xycoords='data',fontsize=13.0,textcoords='data',ha='center')
