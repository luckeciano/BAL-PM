...
exp_names = ['rand_adp_rank_bald_reddit_7b_final', 'ep_adp_rank_bald_reddit_7b_final', 'baepm_reddit_7b_ratiolog_final'] #, 'al_batchent_nounc']
legend_dict = {
...
for i, exp_name in enumerate(exp_names):
    ...
    if legend_dict[exp_name] == 'Random Sampling':
        ...
        ax.annotate(text='~68% fewer samples',xy=(((xstmark+xenmark)/2), -0.665 + 0.0007), xycoords='data',fontsize=15.0,textcoords='data',ha='center')
...
ax.set_yticks([-0.69, -0.66, -0.63])
# # ax.set_yticklabels([-0.62, -0.61])

# ax.set_xlim(2000, 24100)
