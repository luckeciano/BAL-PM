...
exp_names = ['batchstateentropy_stnorm_entunnorm_adp_rank_pred_reddit_7b', 'baepm_reddit_7b_ratiolog_final'] #, 'al_batchent_nounc']
legend_dict = {
    'batchstateentropy_stnorm_entunnorm_adp_rank_pred_reddit_7b': 'Predictive Uncertainty',
    'baepm_reddit_7b_ratiolog_final': 'Epistemic Uncertainty (ours)'
}
...
ax.set_yticks([-0.61, -0.63, -0.65, -0.67])
...
output_name = 'ablation_uncertainty_measure_test_figure'
