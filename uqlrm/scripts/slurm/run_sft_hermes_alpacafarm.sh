...
--output_dir /scratch-ssd/lucelo/sft/results/hermes_sft_alpacafarm \
--dataset_name "luckeciano/alpaca_farm_sft" \
--max_steps 8000 \
--num_train_epochs 50 \
...
--run_name "hermes-sft-alpacafarm" \
...
--preprocess_fn "process_alpacafarm_sft" \
--seq_length 1024 \