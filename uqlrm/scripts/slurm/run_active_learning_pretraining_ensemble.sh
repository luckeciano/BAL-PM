...
python ~/UQLRM/uqlrm/active_learning_pretraining_ensemble.py \
--output_dir /scratch-ssd/lucelo/active_learning/results/$1 \
--model_type "adapters_ens" \
--run_name "$1" \
--dataset_name "['luckeciano/reddit-features-hermes', 'luckeciano/qwen7b-features-reddit', 'luckeciano/gemma7b-features-reddit', 'luckeciano/llama27b-features-reddit', 'luckeciano/falcon7b-features-reddit']" \
--input_size 1024 \
--dataset_type "numpy" \
